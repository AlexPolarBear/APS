...
##########private##########
    ...
    def _generate_map(self, file_path) -> None:
        ...
        self._coordinates_to_items = map_builder._generate_items()
        self._mold_prototype = map_builder._generate_mold_prototype()
        self._coordinates_to_enemies = map_builder._generate_enemies()
